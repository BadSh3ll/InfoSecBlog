...
![website](../../assets/cap/image-20210522070007349.webp)
...
![data/2](../../assets/cap/image-20210522070209222.webp)
...
![data/0](../../assets/cap/pcap.png)

We can download the file and analyze it using Wireshark.

![wireshark](../../assets/cap/wireshark.png)
