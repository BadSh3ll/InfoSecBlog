---
  title: SOC Analyst - Incident Handling Process - Incident Handling
  pubDate: 2024-09-15
  categories: ["Certificates", "CDSA", "Hackthebox", "SOC"]
  description: "What is Incident Handling? The scope of Incident Handling? Value of Incident Handling? What are some generic notes about Incident Handling?"
---

import Section from '../../components/Section.astro'

<Section>Incident Handling Definition & Scope</Section>
...
<Section>Incident Handling's Value & Generic Notes</Section>
...
One of the most widely used resources on incident handling is **[NIST's Computer Security Incident](https://nvlpubs.nist.gov/nistpubs/SpecialPublications/NIST.SP.800-61r2.pdf)** Handling Guide. The document aims to assist organizations in mitigating the risks from computer security incidents by providing practical guidelines on responding to incidents effectively and efficiently.